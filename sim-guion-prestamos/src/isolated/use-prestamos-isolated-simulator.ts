...
import type { IsolatedSimulationPayload } from "@/sim-guion-prestamos/src/isolated/types";
import {
  getAffiliateLabels,
...
export function usePrestamosIsolatedSimulator() {
  ...
  const [simulation, setSimulation] = useState<IsolatedSimulationPayload | null>(null);
